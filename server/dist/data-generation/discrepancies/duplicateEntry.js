...
exports.generateDuplicateEntry = generateDuplicateEntry;
 ...
 */
function generateDuplicateEntry(event, indexSeed) {
    ...
    return {
        ...
        discrepancyType: "duplicateEntry",
    };
}
//# sourceMappingURL=duplicateEntry.js.map