...
exports.generateTrueEvents = generateTrueEvents;
 ...
 */
function randomAmountPaise(rng) {
    const roll = rng();
    let minPaise;
    let maxPaise;
    if (roll < 0.25) {
 ...
 */
function generateTrueEvents(count, seed) {
...
//# sourceMappingURL=generateTrueEvents.js.map